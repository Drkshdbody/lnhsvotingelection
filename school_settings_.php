...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_settings'])) {
    ...
    $settings['custom_system_title'] = trim($_POST['custom_system_title']); // Always update custom title
    ...
    <div class="container">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="custom-title-section">
                ...
                <p><strong>Examples:</strong> "YES-O Election", "BKD Election", "Student Organization Elections"</p>
